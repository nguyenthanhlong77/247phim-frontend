        ...
        <Form noValidate validated={validated} onSubmit={handleSubmit}>
          <Row className="mb-3">
            ...
            <Form.Group as={Col} md="4">
              ...
              <Form.Control {...register('other_name')} type="text" placeholder="Tên khác" />
          ...
          <Row className="mb-3">
            ...
            <Form.Group as={Col} md="2" controlId="validationCustom03">
              ...
              <Form.Control {...register('language')} type="text" placeholder="Ngôn ngữ" />
